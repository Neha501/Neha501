<!--
  This is a verbatim backup of the README.md content that was live at
  github.com/Neha501/Neha501 before the redesign, fetched directly from
  raw.githubusercontent.com on the day of implementation. Kept here so the
  previous version can be restored at any time (see "How to rollback" in
